...
void LinkedListDemo(){
    // 
    LinkedList<DescendingContainerTrait<TI>> list1;
    list1.insert(6, 15);
    list1.insert(2, 25);
    list1.insert(9, 35);
    list1.insert(1, 45);
    ...
    LinkedList<AscendingContainerTrait<TI>> list2;
    using LI = LinkedList<AscendingContainerTrait<TI>>::Node;
    list2.insert(6, 15);
    list2.insert(2, 25);
    list2.insert(9, 35);
    list2.insert(1, 45);
    ...
    LinkedList<AscendingContainerTrait<TI>> list3;
    ...
    LinkedList<AscendingContainerTrait<TI>> list4(list3);
    cout << "Lista ascendente 4: " << list4 << endl;

    list3.push_back(5, 50);
    cout << "Prueba Move Constructor: " << endl;
    LinkedList<AscendingContainerTrait<TI>> list5 = move(list3);
    ...
    LinkedList<AscendingContainerTrait<TI>> list6;
    file >> list6;
